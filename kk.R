...
str(movie1.df)
movie_nn.data <- dummy.data.frame(movie1.df[,-14], sep =".")
str(movie_nn.data)
...
pred.valid.score <- pred.valid$net.result*(max(train1.data$imdb_score)-min(train1.data$imdb_score))+min(train1.data$imdb_score)
valid.score <- (valid_nn.data$imdb_score)*(max(train1.data$imdb_score)-min(train1.data$imdb_score))+min(train1.data$imdb_score)
...
pred.test.score <- pred.test$net.result*(max(train1.data$imdb_score)-min(train1.data$imdb_score))+min(train1.data$imdb_score)
test.score <- (test_nn.data$imdb_score)*(max(train1.data$imdb_score)-min(train1.data$imdb_score))+min(train1.data$imdb_score)
...
pred1_3.valid.score <- pred1_3.valid$net.result*(max(train1.data$imdb_score)-min(train1.data$imdb_score))+min(train1.data$imdb_score)
valid1_3.score <- (valid_nn.data$imdb_score)*(max(train1.data$imdb_score)-min(train1.data$imdb_score))+min(train1.data$imdb_score)

head(data.frame(valid_nn.data$imdb_score,valid1_3.score))
...
head(data.frame(test_nn.data$imdb_score,test1_3.score))
